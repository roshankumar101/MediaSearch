...
const ResultCard = ({item}) => {
  ...
  return (
    <div className='w-44 sm:w-56 h-44 sm:h-60 bg-white rounded-2xl relative'>
      ...
      <div className='absolute bottom-0'>
        <h2 className='text-sm sm:text-md leading-tight font-semibold pl-2 sm:pl-3 pr-4 pb-2 sm:pb-6 capitalize'>{item.title}</h2>
      </div>
      <button onClick={()=>{
